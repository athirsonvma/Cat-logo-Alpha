...
import {
  ...
  Loader2, AlertCircle, Eye, EyeOff, UserPlus, LayoutGrid, CalendarClock
} from 'lucide-react';
import {
...
import {
  KanbanBoard, NewLeadModal, LeadDetailModal, LostReasonModal, TodayView, STAGE_CONFIG,
} from './CrmViews.jsx';
            ...
            <div className="team-content">
              ...
              {crmView === 'board' ? (
                leads.length === 0 ? (
                  ...
                  <KanbanBoard leads={leads} staleDays={STALE_DAYS} onOpenLead={setEditingLead} onStageChange={handleStageChange} />
                )
              ) : (
                <TodayView leads={leads} staleDays={STALE_DAYS} onOpenLead={setEditingLead} />
              )}
            </div>
          )}
