...
export default function App() {
  ...
  return (
    <div className={`re-app ${theme === 'light' ? 'theme-light' : ''}`}>
      ...
      {view === 'team' && (
        <div className="team-shell-sidebar">
          <Sidebar
            activeTab={teamTab}
            onNavigate={setTeamTab}
          ...
          {teamTab === 'home' && (
            <div className="team-content">
              <Home
                ...
                onNewProperty={() => { setEditingProperty(null); setShowPropertyForm(true); }}
              />
            </div>
          )}
          ...
          {teamTab === 'clientes' && (
            <div className="team-content">
              <PlaceholderPage title="Clientes" description="Área de relacionamento pós-venda (indicação, recompra) — chegando na próxima fase." />
            </div>
          )}

          {teamTab === 'agenda' && (
            <div className="team-content">
              <PlaceholderPage title="Agenda" description="Calendário de visitas, reuniões e tarefas — chegando na próxima fase." />
            </div>
          )}

          {teamTab === 'equipe' && (
            <div className="team-content">
              <PlaceholderPage title="Equipe" description="Gestão de corretores e permissões — depende de login individual, ainda não implementado." />
            </div>
          )}

          {teamTab === 'relatorios' && (
            <div className="team-content">
              <PlaceholderPage title="Relatórios" description="Métricas de vendas, conversão e desempenho por corretor — chegando na próxima fase." />
            </div>
          )}

          {teamTab === 'ajuda' && (
            <div className="team-content">
              <PlaceholderPage title="Ajuda" description="Central de ajuda — chegando em breve." />
            </div>
          )}
